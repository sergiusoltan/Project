...
//                AuthFactory.setUser($scope.user);
    ...
    .config(['$routeProvider', '$locationProvider','$httpProvider', function ($routeProvider, $locationProvider,$httpProvider) {
        $routeProvider
            ...
            .when(VIEW_CLIENT, {templateUrl: '/resources/views/people/view-client.html', controller: 'ClientsCtrl'})
            .when(CONTACTS, {templateUrl: '/resources/views/people/contacts.html', controller: 'ContactsCtrl'})
            .when(VIEW_CONTACTS, {templateUrl: '/resources/views/people/view-contact.html', controller: 'ContactsCtrl'})
